...
class Rectangle(Shape):
    def __init__(self, v0, v1, v2, v3, material):
        ...
        # Definir los vértices de los dos triángulos que forman el rectángulo
        self.triangle1 = Triangle(v0, v1, v2, material)
        self.triangle2 = Triangle(v1, v2, v3, material)

        super().__init__(v0, material)

    def ray_intersect(self, origin, direction):
        # Intersectar con los dos triángulos
        intersection1 = self.triangle1.ray_intersect(origin, direction)
        intersection2 = self.triangle2.ray_intersect(origin, direction)
        ...
        return intersection1 if intersection1.distance < intersection2.distance else intersection2
